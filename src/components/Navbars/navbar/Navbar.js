      ...
      <div className="section">
        <div className="navbar-logo">
          ...
          <div>
            <div
              className="div-input"
              onClick={() => setSuggetion(true)}
              onBlur={() => setSuggetion(false)}
            >
              <div>
                <FiSearch />
              </div>
              ...
              <div className=" input_box">
                ...
                <div className="input_suggetion">
                  ...
                  <ul className="input-options">
                    <li className="input_options-list">
                      <span className="option-icon">
                        <img
                          src="https://www.nykaa.com/media/wysiwyg/2020/ic-trending.svg"
                          alt="trending icon"
                        />
                      </span>
                      <span className="options">Nykaa Cosmetics</span>
                    </li>
                    <li>
                      <span className="option-icon">
                        <img
      ...
      <div className="navbar-sign">
        ...
        {toggleMenu && (
          <div className="popup">
            ...
            <div>
              <p>
                Register now and get<b> 2000 Nykaa reward points instantly!</b>
              </p>
            </div>
            <div>
              <Link to="login">
                ...
                <button type="button">
                  ...
                  <div className="arrow">
                    ...
                    >
                      <path
                        d="M9.66667 0.166992L8.41667 1.41699L12.2253 5.22559H0.5V6.89225H12.2253L8.41667 10.7008L9.66667 11.9508L15.5586 6.05892L9.66667 0.166992Z"
                        fill="#E80071"
                      ></path>
                    </svg>
                  </div>
