    ...
    <div className='header'>
        <div className='navbar'>
            <div className='left-div'>
                <div className='item'>
                <GiHamburgerMenu className='icon' onClick={() => setToggleMenu(true)}/>
                </div>
                <div className='item'>
        ...
        <div className="reponsive-menu ">
            ...
            <div className='menu-items'>
                ...
                <div className='menu_items-links'>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Health & Wellness</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Nykaa Luxe</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Pop Ups</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Skin</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Mom & Baby</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Fragrance</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Makeup</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Appliances</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Hair</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Men's Store</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Natural</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>COVID & Home Essentials</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Face Makeup Best Sellers</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Nykaa Network</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Beauty Advices</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Trending Searches</span><span className='menu_button-icon'>+</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Beauty Services</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Gift Card</span></button></div>
                    <div className='button-border'><button type='button' className='menu-buttons'><span className='menu_button-name'>Store & Events</span></button></div>
